...
(async () => {
  ...
  await page.goto('http://127.0.0.1:5175/world/arcade.html',{waitUntil:'domcontentloaded',timeout:20000});
  await page.waitForTimeout(4000);
  await page.screenshot({path:'zeen-tools/arcade-visitors.png'});
