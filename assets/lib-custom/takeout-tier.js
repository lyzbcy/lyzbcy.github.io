(function () {
  ...
  const stalls = [
    ...
    },
    {
      name: '【外卖】肯德基',
      tier: '夯',
      tierLabel: '夯 · 店铺得分 4.50',
      rating: 4.5,
      description:
        '常点芝士鸡肉帕尼尼 + 冰豆浆（官方早餐系列），参考价 8 元。评分锚点店之一：大家都吃过。冰豆浆太好喝了！',
      pros: ['冰豆浆太好喝了', '8 元的早餐组合性价比高'],
      cons: [],
      note: '建议买肯德基早餐卡，或者去闲鱼买代下单，更便宜。',
    },
    {
    ...
    },
    {
      ...
      rating: 4,
      description:
        '常点吉士蛋麦满分组合（一个吉士蛋麦满分 + 一杯热豆浆，官方麦满分家族成员），参考价 7.5 元。评分锚点店之一。蛋汉堡的胚子上面有碎碎的点点，口感特别好；但热豆浆一般般。',
