(function () {
  ...
  const stalls = [
    ...
    {
      name: '【外卖】鑫震源·苏式大虾生煎（滨湖万科店）',
      tier: '夯',
      tierLabel: '夯 · 店铺得分 4.90',
      rating: 4.9,
      description:
        '苏州品牌生煎店（江浙沪特色），滨湖万科店距江大约 1.6 公里。推荐大虾（小龙虾）生煎。外卖正常 22 元能点到一碗虾肉小馄饨 + 一个生煎双拼；很美味但吃不饱，想吃饱要 25 元起步。抛开价格只谈美味，和鑫花溪一样 4.9 星：比鑫花溪贵一点、性价比低一点，但营养更多（有虾肉），综合评分保持 4.9。有条件建议堂食，最近门店 1.6 公里。',
    ...
    },
    {
      ...
      rating: 2.8,
      description:
        '常点盐葱鸡排拌饭（拌饭汁全部添加），参考价 17.5 元。味道和湘八爷的番茄炒蛋盖码饭差不多（3.3 分的水平），但人家不到 10 块钱，你卖 17.5 还量少——性价比太差了。味道不够突出到能靠味道拉分，只能按性价比给分，配不上湘八爷的 3.3。',
      pros: ['味道能达到湘八爷水平'],
      cons: ['17.5 元性价比太差', '量少，吃不饱', '比湘八爷贵一倍但味道相同'],
      note: '味道不差，但 17.5 元卖给穷学生的量，不值得。',
    },
    {
    ...
    {
      name: '【外卖】贵州侗娘牛肉蘸水菜（滨湖店）',
      tier: '夯',
      tierLabel: '夯 · 店铺得分 4.40',
      rating: 4.4,
      description:
        '晚餐套餐，含有牛肉片、虾滑、西兰花、白菜、彩椒等蔬菜，搭配白米饭与蘸酱，参考价 16.28 元。肉和蔬菜的营养都吃到了，比较健康，蛋白质和蔬菜都到位。味道上就是蘸水菜嘛，比较清淡，没有特别让人印象深刻或浓郁的味道，就是加点辣椒吃点辣、吃点滋味。这其实类似于一个加强版的盒饭，或者说是食堂里那种铁盘饭——加强健康版、好吃一点的铁盘饭。吃久了绝对会腻，但蘸水菜一般也不会天天吃，就是偶尔吃吃。偶尔吃一次挺好吃的，而且价格也还可以，给到 4.4 星。\n\n【2026-08-25 更新】这次吃发现米饭看着有一点点拉丝，卫生环境稍微有点让人怀疑（虽然菜本身看不出什么问题）。而且餐具都是不考究的黑塑料，跟那些外卖包装有设计感的品牌根本没法比，体验扣分。好在味道和营养还是在线的，价格也还行。',
      pros: ['肉和蔬菜营养全面', '比较健康', '价格还可以（16.28 元）', '偶尔吃吃挺好的'],
      cons: ['味道比较清淡，没有特别浓郁的口感', '吃久了会腻，不适合连续吃', '米饭疑似有拉丝，卫生环境存疑', '餐具不考究（黑塑料），和设计品牌没法比'],
      note: '偶尔改善伙食的好选择，健康版铁盘饭，但米饭卫生和餐具质感在线下分。',
    },
    {
      name: '【外卖】如意馄饨·番茄浓汤馄饨面',
      tier: '夯',
      tierLabel: '夯 · 店铺得分 4.45',
      rating: 4.45,
      description:
        '常点番茄浓汤馄饨面（京东外卖），实付参考价约 12.77 元。味道很不错，鲜美馄饨，番茄汤很浓郁。高中时候就喜欢"科研"馄饨泡饭——把馄饨和米饭泡在一起吃，特别特别好吃。这碗面相当于一个"科研"馄饨泡饭，嘴巴里吃着感觉很有意思。作为大品牌，卫生肯定没问题，吃着放心。而且做了防坨处理，汤和料是分开的，细节上做得不错。不过外卖细节肯定还是没有和府捞面做得那么好，所以给 4.45 星。',
      pros: ['味道鲜美，番茄汤浓郁', '大品牌卫生放心', '防坨处理细节加分', '"科研"馄饨泡饭的吃法很有意思'],
      cons: ['外卖包装细节不如和府捞面'],
      note: '科研吃法：馄饨面泡米饭，高中回忆杀。',
    },
    {
      name: '【外卖】迷迭香麻辣味原切前胸牛肉粉',
      tier: 'NPC',
      tierLabel: 'NPC · 店铺得分 2.50',
      rating: 2.5,
      description:
        '常点迷迭香麻辣味原切前胸牛肉粉（带炸蛋、白菜、金针菇和黄豆），参考价 21 元。味道还行，但就是油多那种好吃——油多不可能不好吃，但也不能这么说。料其实也就一个小炸蛋，有一些脆脆的，荤菜肥牛估计就一两片。油太多了，随便捞一点米线都能捞出来太多油，完全不值这个价，感觉卖 12 块钱差不多了，结果卖 21 块钱。不过它也不难吃，NPC 档。',
      pros: ['味道还过得去，不难吃'],
      cons: ['太油了，油多到随便一捞都是油', '21 元性价比很差，感觉只值 12 元', '肥牛一两片，荤菜量太少', '配菜就一个小炸蛋加几样素菜'],
      note: '不值这个价，不推荐。',
    },
    {
      name: '【外卖】陈香贵兰州牛肉面',
      ...
      rating: 3.15,
      description:
        '常点招牌牛骨清汤牛肉面加煎蛋，搭配现烤牛肉夹馍，参考价30元（首单评价返券后十几块，正常价25~28元，堂食无限加面约20元）。兰州牛肉拉面本来就好吃，味道没毛病，单说味道在人上人到顶尖之间。肉夹馍外皮是千层酥的，很好吃，量也可以。面稍微有点少，不加肉夹馍吃不饱，但加了就能吃饱。肉给得挺足的。问题是30块钱一份，其他外卖十几块，你拿30的去跟人家十几块的竞争，本身就有点赖皮。',
      pros: ['兰州牛肉拉面味道正宗好吃', '肉夹馍千层酥皮很好吃', '肉给得挺足的', '堂食可无限加面', '首单评价返券后只要十几块'],
      cons: ['正常价25~28元偏贵，一碗面不值这个价', '光吃面量偏少，不加肉夹馍吃不饱', '和其他十几块的外卖相比性价比差', '堂食也要20块钱'],
      note: '建议领券或首单去吃，肉夹馍必点。面+肉夹馍才吃得饱。',
    },
  ];
