(function () {
  ...
  const stalls = [
    ...
    },
    {
      ...
      tier: 'NPC',
      tierLabel: 'NPC · 2026-08 下调（被龙哥暴打）',
      rating: 2,
      description:
    ...
    },
    {
      ...
      rating: 3,
      description:
        '大悦城 B1 的火锅鸡店，整体体验达到入围水准，具体细节未展开描述，可视作伍夸火锅鸡的平替或补充选项。',
      pros: [],
      cons: [],
      note: '',
    },
    {
      ...
      rating: 3,
      description:
        '星光广场二楼的火锅鸡，相比伍夸火锅鸡，环境更好，有雅座，整体不那么拥挤，味道也不错，适合在星光周边就近解决聚餐需求。',
      pros: [
        '环境比伍夸火锅鸡好，有一定私密度',
        '味道表现不错，适合不想排太久队的场景',
      ],
    ...
    // 🥗 正餐：炒菜 / 地方菜
    {
      name: '【星光广场】重返白桦林',
      tier: '顶级',
      tierLabel: '顶级 · 4 星（环境好，老资历爱去，味道一般）',
      rating: 4,
      description:
        '星光广场内的正餐馆，有露台，夏天晚上氛围很好，老资历喜欢去吃，味道其实一般般，整体有故事感；菜品包含无锡特色菜（如油面筋等），口味中上，价格合适且学生可打折，是招待朋友和聚餐的首选之一。',
      pros: [
        '露台+夜景氛围感强，适合拍照和聊天',
        '有无锡本地特色菜，口味稳定在中上',
        '学生有折扣，整体价格友好',
    ...
    // 🍜 粉面 / 简餐（一人食）
    {
      ...
      tierLabel: '人上人 · 酸甜米线',
      rating: 3,
      description: '酸酸甜甜，口味不错，对标“鑫花溪”，作为米线选项体验良好。但价格有点高了，这个价位不如直接去吃鑫花溪。',
    ...
    },
    {
      ...
      rating: 2,
      description:
        '汉堡连锁。堂食真的不行——虽然有几张桌子，但在那儿吃肯定很别扭，只适合拿回去吃。味道一般般，本来想给 2.5 星，但毕竟是哪儿都能吃到的连锁，就按 2 星算。突出的点是性价比：截至 2026 年 8 月依然很能打，单人餐 16.6 元，双人六件套 24.9 元——双人餐可以吃成巨人观。整体感觉不如汉堡王。',
    ...
    },
    {
      name: '【大悦城负一楼】清膳记药膳鸡',
      tier: '拉完了',
      tierLabel: '拉完了 · 1.9 星（档内第一；不吃中药味避雷）',
      rating: 1.9,
      description:
        '先声明：有的人就是喜欢中药味，我只是不喜欢才给这么低。档内按星级排序，1.9 星排在 1 星前面。药膳鸡单人餐 44 元，有的人喜欢它的中药味，但我不太喜欢，不好意思，只能给 1.9 星。小菜自助，但至少我去的那天小菜卫生质量一般、都是很一般的蔬菜。吃肯定能吃饱——44 块钱去哪家连锁店正常吃都能吃饱。一股中药味，不喜欢。',
      pros: ['小菜自助，能吃饱'],
      cons: ['一股中药味（不喜欢的会很痛苦）', '小菜卫生质量一般', '44 元性价比低'],
      note: '',
    },
    {
      name: '【无锡万象城·打车2.7公里】龙哥自助',
      tier: '夯',
      tierLabel: '夯 · 4.3 星（性价比自助）',
      rating: 4.3,
      description:
        '在无锡万象城，离学校 2.7 公里，得打车去（10 块出头）。自助参考价 57 元左右。品质其实跟冯宝宝肥牛小火锅差不多，但这里可以随便拿、随便吃——性价比直接把冯宝宝暴打。味道可以给 4.3 星。',
      pros: ['57 元自助随便吃', '品质与冯宝宝同级但无限量', '性价比极高'],
      cons: ['在万象城，要打车去'],
      note: '',
    },
    {
      name: '【滨湖万象城·2.5公里】海底捞',
      tier: '夯',
      tierLabel: '夯 · 4.5 星（聚餐约会向，贵）',
      rating: 4.5,
      description:
        '最近的门店在滨湖万象城 2.5 公里（万象汇那家 5.8 公里），得打车去。正常吃基本 300～600 元，适合聚餐或约会。到了这个价格，服务和美味肯定没得说，光美味程度 4.5 星左右，加上服务，4.5 星没毛病。缺点就是远。',
      pros: ['服务和美味都没得说', '聚餐约会体面'],
      cons: ['人均很高（300～600 元档）', '要打车去'],
      note: '',
    },
    {
      name: '【无锡万象汇·与龙哥同地】流浪泡泡',
      tier: 'NPC',
      tierLabel: 'NPC · 2 星（与钱小奴同级）',
      rating: 2,
      description:
        '各店水平不一，一开始印象很差，但无锡万象汇这家（跟龙哥同一个地方）比较好：有韩国那种泡面台，很多泡面随便选，吃的也不错。65 元左右挺实惠，就是没什么海鲜。跟钱小奴排一档：钱小奴离得近、降到 80 元了，肯定比流浪泡泡好一些；去流浪泡泡算上打车也要七八十，所以同级。',
      pros: ['泡面台有特色', '65 元左右实惠'],
      cons: ['没什么海鲜', '要打车，算上车费不划算', '各门店水平不一'],
      note: '',
    },
    {
      name: '【大悦城负一楼】和府捞面（堂食）',
      tier: '人上人',
      tierLabel: '人上人 · 3.5 星（外卖赛道它是夯）',
      rating: 3.5,
      description:
        '外卖我给了 5 星——外卖赛道对手是包装破破烂烂的同行，它包装太好、味道也有堂食水准。但放到堂食赛道：外卖 20 出头，堂食怎么点都要近 30 块。虽然堂食可以无限加面，综合性价比和美味程度，3.5 星。',
      pros: ['味道稳定', '堂食可无限加面', '环境舒适'],
      cons: ['堂食比外卖贵近 10 元', '性价比一般'],
      note: '想便宜点它家外卖，详见外卖篇。',
    },
  ];
